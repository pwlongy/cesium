...
function () {
  ...
  initCesium.prototype.bindClick = function () {
    var _this = this; // 创建 ScreenSpaceEventHandler 对象
    ...
    handler.setInputAction(function (e) {
      ...
      if (Cesium.defined(position)) {
        var cartographic = Cesium.Cartographic.fromCartesian(position); // console.log(cartographic);
  ...
  initCesium.prototype.getCameraPosition = function () {
    var camera = this.viewer.camera; // 获取相机位置

    var cameraPosition = camera.positionWC; // 获取相机方向
